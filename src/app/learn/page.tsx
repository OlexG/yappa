...
export default function LearnPage() {
  ...
  const generateSections = async () => {
    ...
    try {
      ...
      localStorage.setItem('learnTopic', topic);
      localStorage.setItem('learnTime', timeSelected.toString());
      localStorage.setItem('learnSections', JSON.stringify(generatedSections));
        ...
        <main className="flex-grow bg-gradient-to-b from-white to-gray-100">
          ...
          <div className="max-w-4xl mx-auto px-6 py-12">
            <div className="text-center mb-12">
              <h1 className="text-3xl font-bold text-gray-800 mb-4">{currentQ.title}</h1>
            </div>

            {/* Progress bar */}
            <div className="w-full bg-gray-200 rounded-full h-1.5 mb-8">
              <div 
                className="bg-gradient-to-r from-black to-gray-600 h-1.5 rounded-full transition-all duration-300"
            ...
            <div className="flex justify-between items-center">
              ...
              >
                {currentQuestion === questions.length - 1 ? 'Start Learning' : 'Next'}
              </button>
            </div>
          </div>
        </main>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="mt-2 flex items-center">
                      <div className="w-full bg-gray-200 rounded-full h-2.5">
                        <div 
                          className="bg-gradient-to-r from-black to-gray-600 h-2.5 rounded-full" 
